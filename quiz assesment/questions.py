...
questions = [
    ...
    # STAR WARS
    {"topic": "Star Wars", "qns": "What is the name of Han Solo’s ship?", 
     "options": ["X-Wing", "Millennium Falcon", "TIE Fighter", "Slave I"], "Correct Ans": "Millennium Falcon"},
    
    {"topic": "Star Wars", "qns": "Who trained Luke Skywalker?", 
     "options": ["Yoda", "Mace Windu", "Obi-Wan Kenobi", "Darth Vader"], "Correct Ans": "Obi-Wan Kenobi"},
    
    {"topic": "Star Wars", "qns": "What is Darth Vader’s real name?", 
     "options": ["Darth Maul", "Sheev Palpatine", "Anakin Skywalker", "Ben Solo"], "Correct Ans": "Anakin Skywalker"},
    
    {"topic": "Star Wars", "qns": "What species is Yoda?", 
     "options": ["Human", "Yoda’s Species", "Togruta", "Wookiee"], "Correct Ans": "Yoda’s Species"},
    
    {"topic": "Star Wars", "qns": "Who said 'I am your father'?", 
     "options": ["Obi-Wan Kenobi", "Darth Vader", "Yoda", "Emperor Palpatine"], "Correct Ans": "Darth Vader"}
]